/*****************************************************************************
 ...
 @(#) test-nuls.c,v OpenSS7-0_9_2_D_rc2(0.9.2.22) 2006/03/03 10:57:15
 ...
 test-nuls.c,v
 Revision 0.9.2.22  2006/03/03 10:57:15  brian
 - 32-bit compatibility support, updates for release

 Revision 0.9.2.21  2006/02/22 19:57:34  brian
 - strap out lockf() that was blocking some test case
   processes on SMP and even on UP

 Revision 0.9.2.20  2005/12/28 09:48:05  brian
...
#ident "@(#) test-nuls.c,v OpenSS7-0_9_2_D_rc2(0.9.2.22) 2006/03/03 10:57:15"

static char const ident[] = "test-nuls.c,v OpenSS7-0_9_2_D_rc2(0.9.2.22) 2006/03/03 10:57:15";
